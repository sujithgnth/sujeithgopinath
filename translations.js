window.portfolioTranslations = {
  en: {
    "meta.title":
      "Senior Full-Stack TypeScript Engineer in Dresden | Sujeith Gopinath",
    "meta.description":
      "Sujeith Gopinath is a Senior Full-Stack TypeScript Engineer in Dresden with 10+ years of experience designing scalable TypeScript applications with React, Angular and frontend architecture.",
    "meta.socialDescription":
      "Senior Full-Stack TypeScript Engineer in Dresden specialising in TypeScript, React, Angular and scalable frontend architecture for complex products.",
    "meta.imageAlt":
      "Portfolio of Sujeith Gopinath, Senior Full-Stack TypeScript Engineer in Dresden",
    ...
    "accessibility.switchToDark": "Switch to dark theme",
    ...
    "metrics.loadLabel": "measured load time — from 7.0s to 1.7s",
    ...
    "work.elevait.visual.confidence": "Confidence 98%",
    "work.elevait.visual.needsReview": "Needs review",
    "work.elevait.visual.checkSource": "Check source region",
    "work.elevait.visual.reject": "Reject",
    "work.elevait.visual.approve": "Approve",
    "work.coboworx.kicker": "Robotics workflow design",
    "work.coboworx.title":
    ...
    "work.coboworx.point4":
      "Established architecture and code-review standards across internal and external contributors, with reusable components and Cypress regression coverage",
    ...
    "archive.swiggy.title": "Restaurant ordering built for rapid growth",
    "archive.swiggy.description":
      "As primary frontend engineer, I owned restaurant-vendor workflows as daily usage grew from approximately 3,000 to 27,000 users. I also built and maintained a Node.js/Express backend-for-frontend layer using GraphQL/Apollo and Redis.",
    ...
    "archive.loadshare.visual.network": "Live shipment network",
    ...
    "archive.loadshare.visual.auditNode": "Audit",
    ...
    "archive.swiggy.visual.queue": "Order queue",
    ...
    "archive.swiggy.visual.riderAssigned": "Rider assigned",
    ...
    "experience.juniorRole": "Junior UI Developer",
    "experience.elevaitDomain":
      "AI document processing · Angular · TypeScript · NestJS",
    "experience.coboworxDomain": "Robotics · React · TypeScript · Storybook",
    "experience.loadshareDomain": "Logistics · React · TypeScript · Node.js",
    "experience.swiggyDomain": "Food delivery · React · GraphQL · PWA",
    "experience.pipemonkDomain":
      "Cloud integration · AngularJS · Bootstrap · Firebase",
    "experience.educationLabel": "Education",
    "experience.education":
      "Bachelor of Engineering in Electronics and Communication",
    "experience.languagesLabel": "Languages",
    "experience.languages":
      "English C1 · German A2 (B1 in progress) · Malayalam native",
    ...
    "resume.intro":
      "View my English or German résumé without leaving this page, or save a PDF copy for later.",
    "resume.english.pageCount": "2 pages · PDF",
    "resume.english.version": "English version",
    "resume.english.title": "English résumé",
    "resume.english.meta": "English · 2 pages",
    "resume.english.page1Alt": "English résumé, page 1 of 2",
    "resume.english.page2Alt": "English résumé, page 2 of 2",
    "resume.german.pageCount": "3 pages · PDF",
    "resume.german.version": "German version",
    "resume.german.title": "German résumé",
    "resume.german.meta": "German · 3 pages",
    ...
    "resume.close": "Close",
    "contact.eyebrow": "Let’s build something useful",
    "contact.title":
      "Looking for a senior engineer who cares about the product as much as the code?",
    "footer.role":
      "Senior Full-Stack TypeScript Engineer · TypeScript · React · Angular · Dresden, Germany",
  },
  de: {
    "meta.title":
      "Senior Full-Stack TypeScript Engineer in Dresden | Sujeith Gopinath",
    "meta.description":
      "Sujeith Gopinath ist Senior Full-Stack TypeScript Engineer in Dresden mit über 10 Jahren Erfahrung in skalierbaren TypeScript-Anwendungen, React, Angular und Frontend-Architektur.",
    "meta.socialDescription":
      "Senior Full-Stack TypeScript Engineer in Dresden mit Schwerpunkt auf TypeScript, React, Angular und skalierbarer Frontend-Architektur für komplexe Produkte.",
    "meta.imageAlt":
      "Portfolio von Sujeith Gopinath, Senior Full-Stack TypeScript Engineer in Dresden",
    ...
    "accessibility.switchToDark": "Zum dunklen Design wechseln",
    ...
    "nav.contact": "Kontakt",
    "hero.eyebrow":
      "Senior Full-Stack TypeScript Engineer · React · Angular · Node.js · NestJS",
    "hero.title":
    ...
    "metrics.loadLabel": "gemessene Ladezeit – von 7,0 s auf 1,7 s",
    ...
    "work.elevait.visual.confidence": "Konfidenz 98 %",
    "work.elevait.visual.needsReview": "Prüfung erforderlich",
    "work.elevait.visual.checkSource": "Quellbereich prüfen",
    "work.elevait.visual.reject": "Ablehnen",
    "work.elevait.visual.approve": "Bestätigen",
    "work.coboworx.kicker": "Design von Robotik-Workflows",
    "work.coboworx.title":
      "Roboterbewegungen in ein visuelles, bedienbares Produkt übersetzen.",
    "work.coboworx.description":
      "Ich leitete die Migration und interne Übernahme der React/TypeScript-Robotersteuerung und etablierte interne Verantwortung für Architektur und Auslieferungsstandards. Zentrale Produktbereiche im React-Frontend und in unterstützenden APIs entstanden innerhalb von 4 Monaten.",
    ...
    "work.coboworx.point4":
      "Etablierte Architektur- und Code-Review-Standards für interne und externe Entwickler, wiederverwendbare Komponenten und Cypress-Regressionstests",
    ...
    "archive.swiggy.title": "Restaurantbestellungen für schnelles Wachstum",
    "archive.swiggy.description":
      "Als verantwortlicher Frontend-Entwickler betreute ich Restaurant-Bestellabläufe, während die tägliche Nutzung von rund 3.000 auf 25.000 Nutzer stieg. Zusätzlich entwickelte und pflegte ich eine Node.js/Express-Backend-for-Frontend-Schicht mit GraphQL/Apollo und Redis.",
    "archive.swiggy.point1":
    ...
    "archive.loadshare.visual.network": "Live-Sendungsnetz",
    "archive.loadshare.visual.pickup": "Abholung",
    "archive.loadshare.visual.hub": "Hub-Scan",
    "archive.loadshare.visual.destination": "Ziel",
    "archive.loadshare.visual.auditNode": "Prüfung",
    ...
    "archive.swiggy.visual.queue": "Bestelleingang",
    ...
    "archive.swiggy.visual.riderAssigned": "Fahrer zugewiesen",
    ...
    "experience.juniorRole": "Junior UI-Entwickler",
    "experience.elevaitDomain":
      "KI-Dokumentenverarbeitung · Angular · TypeScript · NestJS",
    "experience.coboworxDomain": "Robotik · React · TypeScript · Storybook",
    "experience.loadshareDomain": "Logistik · React · TypeScript · Node.js",
    "experience.swiggyDomain": "Essenslieferung · React · GraphQL · PWA",
    "experience.pipemonkDomain":
      "Cloud-Integration · AngularJS · Bootstrap · Firebase",
    "experience.educationLabel": "Studium",
    "experience.education":
      "Bachelor of Engineering in Electronics and Communication",
    "experience.languagesLabel": "Sprachen",
    "experience.languages":
      "Englisch C1 · Deutsch A2 (B1 in Arbeit) · Malayalam Muttersprache",
    "experience.languageNote":
    ...
    "resume.intro":
      "Englischen oder deutschen Lebenslauf direkt hier ansehen oder als PDF speichern.",
    "resume.english.pageCount": "2 Seiten · PDF",
    "resume.english.version": "Englische Version",
    "resume.english.title": "Englischer Lebenslauf",
    "resume.english.meta": "Englisch · 2 Seiten",
    "resume.english.page1Alt": "Englischer Lebenslauf, Seite 1 von 2",
    "resume.english.page2Alt": "Englischer Lebenslauf, Seite 2 von 2",
    "resume.german.pageCount": "3 Seiten · PDF",
    "resume.german.version": "Deutsche Version",
    "resume.german.title": "Deutscher Lebenslauf",
    "resume.german.meta": "Deutsch · 3 Seiten",
    "resume.german.page1Alt": "Deutscher Lebenslauf, Seite 1 von 3",
    ...
    "contact.eyebrow": "Lassen Sie uns etwas Nützliches entwickeln",
    "contact.title":
      "Sie suchen einen Senior Engineer, dem das Produkt genauso wichtig ist wie der Code?",
    "footer.role":
      "Senior Full-Stack TypeScript Engineer · React · Angular · Node.js · NestJS · Dresden, Deutschland",
  },
};
